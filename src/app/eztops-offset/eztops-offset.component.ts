...
@Component({
  selector: 'app-eztops-offset',
  templateUrl: './eztops-offset.component.html',
  styleUrls: ['./eztops-offset.component.css']
})
export class EztopsOffsetComponent implements OnInit {
